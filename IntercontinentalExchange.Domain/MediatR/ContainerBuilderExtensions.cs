...
namespace IntercontinentalExchange.Domain.MediatR
{
    internal static class ContainerBuilderExtensions
    {
        ...
        //public static ContainerBuilder RegisterMediatR(this ContainerBuilder builder, IEnumerable<Type> customBehaviorTypes, IEnumerable<Assembly> assemblies)
        ...
        public static ContainerBuilder RegisterMediatR(this ContainerBuilder builder,
            Assembly assembly /*, params Type[] customBehaviorTypes*/)
            => RegisterMediatRInternal(builder, new[] {assembly} /*, customBehaviorTypes*/);

        private static ContainerBuilder RegisterMediatRInternal(ContainerBuilder builder,
            IEnumerable<Assembly> assemblies /*, IEnumerable<Type> customBehaviorTypes = null*/)
        {
